...
export function usePolarChart(artifact: GraphArtifact, vars: Record<string, number>) {
  ...
  useEffect(() => {
    ...
    // Cardinal labels
    ctx.fillStyle = "rgba(0,0,0,0.25)"; ctx.font = "9px Inter, system-ui, sans-serif"; ctx.textAlign = "center";
